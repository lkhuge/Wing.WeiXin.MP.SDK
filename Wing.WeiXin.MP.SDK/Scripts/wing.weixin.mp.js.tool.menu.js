(function($) {
	...
	function addButtonAddMain(id, empty) {
		...
		$('#' + toolIDPrefix + 'footer-' + id).append(html);
		bindButtonAddMain(id);
	}

	function bindButtonAddSub(id) {
		/// <summary>
		/// 绑定添加子菜单按钮事件
		/// </summary>
		/// <param name="id" type="Number">主菜单ID</param>
	...
	function bindButtonDeleteSub(id) {
		/// <summary>
		/// 绑定删除子菜单按钮事件
		/// </summary>
		/// <param name="id" type="Number">主菜单ID</param>
	...
	function bindButtonDeleteMain(id) {
		/// <summary>
		/// 绑定删除主菜单按钮事件
		/// </summary>
		/// <param name="id" type="Number">主菜单ID</param>
	...
	function bindButtonModityMain(id) {
		/// <summary>
		/// 绑定修改主菜单按钮事件
		/// </summary>
		/// <param name="id" type="Number">主菜单ID</param>
