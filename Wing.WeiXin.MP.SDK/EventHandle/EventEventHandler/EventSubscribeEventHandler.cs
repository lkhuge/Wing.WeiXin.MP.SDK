...
namespace Wing.WeiXin.MP.SDK.EventHandle.EventEventHandler
{
    ...
    /// 关注事件事件处理
    /// </summary>
    public class EventSubscribeEventHandler : EntityEventHandler<EventSubscribe>
    {
        #region 基础事件处理 protected override IReturn BaseEntityEvent(EventSubscribe entity)
        /// <summary>
        /// 基础事件处理
        /// </summary>
        /// <param name="entity">实体</param>
        /// <returns>返回实体</returns>
        protected override IReturn BaseEntityEvent(EventSubscribe entity)
        {
