...
namespace Wing.WeiXin.MP.SDK.EventHandle.EventEventHandler
{
    ...
    /// 带参数二维码事件事件处理
    /// </summary>
    public class EventWithQRSceneEventHandler : EntityEventHandler<EventWithQRScene>
    {
        #region 基础事件处理 protected override IReturn BaseEntityEvent(EventWithQRScene entity)
        /// <summary>
        /// 基础事件处理
        /// </summary>
        /// <param name="entity">实体</param>
        /// <returns>返回实体</returns>
        protected override IReturn BaseEntityEvent(EventWithQRScene entity)
        {
