...
namespace Wing.WeiXin.MP.SDK.Lib.StringManager
{
    ...
    public static class StringMaker
    {
        ...
        #region 获取随机字符串 public static string GetRamdomString(int length, bool HasNum, bool HasString, StringType stringType)
        /// <summary>
        /// 获取随机字符串
        /// </summary>
        ...
        public static string GetRamdomString(int length, bool HasNum, bool HasString, UDStringType stringType)
        {
