...
namespace Wing.WeiXin.MP.SDK.Controller
{
    ...
    {
        #region 创建二维码ticket public static QRCodeTicket GetQRCodeTicket(QRCodeTicketRequest qrCodeTicketRequest)
        /// <summary>
        /// 创建二维码ticket
        /// </summary>
        /// <param name="qrCodeTicketRequest">二维码ticket请求</param>
        /// <returns>二维码ticket</returns>
        public static QRCodeTicket GetQRCodeTicket(QRCodeTicketRequest qrCodeTicketRequest)
        {
            string result = HTTPHelper.Post(URLManager.GetURLForCreateQRCodeTicket(), 
